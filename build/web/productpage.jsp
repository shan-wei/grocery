        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    <div class="row g-4">
                        <% for (Product product : productList) { %>
                            <% if ("CAT001".equals(product.getCategoryid().getCategoryid())) { %>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="product-item">
                                    ...
                                    <div class="text-center p-4">
                                        ...
                                        <span class="text-primary me-1 price">RM <%= product.getProdprice() %></span>
                                    </div>
                                    <div class="d-flex border-top">
                                        <small class="w-50 text-center border-end py-2">
                                            <a class="text-body" onclick="getDetail('<%= product.getProddesc() %>')"><i class="fa fa-eye text-primary me-2"></i>View detail</a>
                                        </small>
                                        <small class="w-50 text-center py-2">
                                            <a href="#" data-name="<%= product.getProdname() %>" data-price="<%= product.getProdprice() %>" class="add-to-cart"><i class="fa fa-shopping-bag text-primary me-2 addtocart"></i>Add to cart</a>
                                        </small>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="tab-2" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        <% for (Product product : productList) { %>
                            <% if ("CAT002".equals(product.getCategoryid().getCategoryid())) { %>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="product-item">
                                    <div class="position-relative bg-light overflow-hidden">
                                        <img class="img-fluid w-100" src="img/product-1.jpg" alt="">
                ...
                <div id="tab-3" class="tab-pane fade show p-0">
                    <div class="row g-4">
                        <% for (Product product : productList) { %>
                            <% if ("CAT003".equals(product.getCategoryid().getCategoryid())) { %>
                            <div class="col-xl-3 col-lg-4 col-md-6">
                                <div class="product-item">
                                    <div class="position-relative bg-light overflow-hidden">
                                        <img class="img-fluid w-100" src="img/product-1.jpg" alt="">
                ...
                <div class="col-12 text-center wow fadeInUp" data-wow-delay="0.1s" style="position: relative; top: 10px; width: 100%;">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div>Description:  <span class="description"></span></div>
                </div>
